...
from vspipe.modules.websocket_server import WebSocketServer
from vspipe.modules.websocket_server.stubs.aftereffects_server_stub import (
...
def launch(application):
    ...
    if os.environ.get("AVALON_AFTEREFFECTS_WORKFILES_ON_LAUNCH", False):
